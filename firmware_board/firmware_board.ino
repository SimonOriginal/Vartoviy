// Инструкции по обработке общей кнопки
// Одиночное нажатие:
// - Нажмите кнопку один раз.
// - Инициирует конфигурацию Wi-Fi в режиме Wi-Fi STA.
// - Проверяет соединение Wi-Fi в режиме тестирования Wi-Fi.

// Двойное нажатие:
// - Быстро нажмите кнопку дважды.
// - Переключает режимы Wi-Fi STA и тестирования Wi-Fi (не в режиме сотовой связи).

// Таймаут двойного нажатия:
// - Для отмены действия двойного нажатия подождите несколько секунд после первого нажатия.

// Тройное нажатие:
// - Быстро нажмите кнопку три раза.
// - Выполняет включение и выключение модуля A9G.

// Таймаут тройного нажатия:
// - Для отмены действия тройного нажатия подождите несколько секунд после второго нажатия.

// Важные замечания:
// - Подождите время антидребезга после нажатия для корректного распознавания действия.
// - При необходимости следуйте инструкциям на экране в режиме конфигурации Wi-Fi.
...
//PubSubClient mqttClient(espClient); // Если что-то не работает посмотри сюда на всякий случай
...
// Дебаунсер для кнопки // Константы для работы с кнопками

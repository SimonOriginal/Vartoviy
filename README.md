...
**Отмечу, что "Vartoviy" в настоящее время находится в стадии бета-тестирования. Несмотря на то, что он предполагается для эффективного использования большинством пользователей, стоит учитывать наличие ошибок и отсутствие некоторых функций.**
